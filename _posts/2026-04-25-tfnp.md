...
TFNP is the class of problems where a solution is mathematically guaranteed to exist for every instance, and when given one, we can quickly verify it. The entire challenge is to actually _find_ said solution. An easy example is the problem of Factorisation: 

<div class="defn" text="Factorisation" markdown="1">
